...
export default function Footer() {
  return (
    <footer className="footer items-center p-4  px-6 lg:px-12 text-neutral">
      <div className="items-center grid-flow-col">
        ...
        <p>Copyright © 2023 - Z-WordCounter All right reserved</p>
      </div>
      ...
      <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        ...
        <a href="https://dariaz-zidane.netlify.app/" target="_blank">
          <FaExternalLinkAlt className="w-5 h-6 text-sky-500" />
        </a>
      </div>
    </footer>
  );
