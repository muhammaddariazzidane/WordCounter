...
export default function Footer() {
  return (
    <footer className="footer items-center p-4 dark:bg-slate-800 bg-white transition-all duration-300 px-6 lg:px-12 text-neutral">
      <div className="items-center grid-flow-col">
        ...
        <p className="text-black dark:text-slate-200 transition-all duration-300">
          Copyright © 2023 - Z-WordCounter All right reserved
        </p>
      </div>
